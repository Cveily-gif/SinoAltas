...
import { f as getDestination } from "./router-CqkcaWL6.mjs";
import { t as SectionKicker } from "./section-kicker-4-DyksyX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/experiences-KMawvJsn.js
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "风景之外，中国还有可以被喝、被吃、被写、被走进去的部分。"
					})
				]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mx-auto max-w-7xl px-4 py-8 sm:px-6",
			children: experiences.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				id: e.slug,
				className: "grid scroll-mt-24 items-center gap-8 border-b border-ink/8 py-14 md:grid-cols-12 md:gap-12",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: i % 2 === 1 ? "md:col-span-6 md:order-2" : "md:col-span-6",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 font-display text-lg text-ink/80",
							children: e.excerpt
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
