...
import { o as Bookmark, s as ArrowRight, t as X } from "../_libs/lucide-react.mjs";
import { a as cn, c as usePlannerHydration, f as getDestination, o as composeItinerary, p as regions, s as usePlanner, u as destinations } from "./router-CqkcaWL6.mjs";
import { t as Button } from "./button-DXxJfoVU.mjs";
import { t as SaveButton } from "./save-button-D6voWDjD.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-xMn47Ct6.js
...
var F = Math.cos(PHI1) * Math.tan(Math.PI / 4 + PHI1 / 2) ** N / N;
var RHO0 = F / Math.tan(Math.PI / 4 + PHI0 / 2) ** N;
...
function toQuantized(lon, lat, bounds, q) {
...
function shortProvinceName(name) {
	return name.replace(/维吾尔自治区|壮族自治区|回族自治区|特别行政区|自治区|省|市/g, "");
}
var NO_CITY_SPLIT$1 = /* @__PURE__ */ new Set([
	"11",
	"12",
	"31",
	"50",
...
function nearPolyline(x, y, lines, tol2) {
...
function cityInteriorLines(cities, provinceBorders) {
	const tol2 = 121;
	const lines = [];
...
var ChinaMap = (0, import_react.forwardRef)(function ChinaMap({ data, hoverIndex, selectedIndex, selectedSlug, saved, onHoverProvince, onSelectProvince, onSelectDest, onHoverDest }, ref) {
	...
	const focusFitRef = (0, import_react.useRef)(null);
	const sizeRef = (0, import_react.useRef)({
		w: 0,
		h: 0
	});
	const fadeRef = (0, import_react.useRef)(0);
	const focusIndexRef = (0, import_react.useRef)(null);
	const lingerIndexRef = (0, import_react.useRef)(null);
	const savedViewRef = (0, import_react.useRef)(null);
	const denseCache = (0, import_react.useRef)(/* @__PURE__ */ new Map());
	const animatingRef = (0, import_react.useRef)(false);
	const animRaf = (0, import_react.useRef)(0);
	(0, import_react.useRef)(0);
	const hoverDest = (0, import_react.useRef)(null);
	const hoverCity = (0, import_react.useRef)(null);
	const pointer0 = (0, import_react.useRef)(null);
	const dragging = (0, import_react.useRef)(false);
	const pointers = (0, import_react.useRef)(/* @__PURE__ */ new Map());
	const pinch0 = (0, import_react.useRef)(null);
	const raf = (0, import_react.useRef)(0);
	const drawRef = (0, import_react.useRef)(() => {});
	const exitFocusRef = (0, import_react.useRef)(() => {});
	const insetLayoutRef = (0, import_react.useRef)([]);
	const [cursor, setCursor] = (0, import_react.useState)("crosshair");
	const [cityBadge, setCityBadge] = (0, import_react.useState)(null);
	const MAX_Z = 7;
	if (selectedIndex != null) {
		focusIndexRef.current = selectedIndex;
		lingerIndexRef.current = selectedIndex;
	} else focusIndexRef.current = null;
	...
	const landBox = (0, import_react.useMemo)(() => {
		let minx = Infinity, miny = Infinity, maxx = -Infinity, maxy = -Infinity;
	...
	const provMeta = (0, import_react.useMemo)(() => {
	...
	const hitOrder = (0, import_react.useMemo)(() => [...provMeta].sort((a, b) => a.area - b.area), [provMeta]);
	const insetSpecs = (0, import_react.useMemo)(() => {
		const specs = [];
	...
	const cityInteriors = (0, import_react.useMemo)(() => data.provinces.map((p) => {
		if (!p.cities?.length || NO_CITY_SPLIT$1.has(p.id)) return [];
		return cityInteriorLines(p.cities, p.borders);
	}), [data.provinces]);
	const hitProvince = (0, import_react.useCallback)((x, y) => {
	...
	const computeFit = (0, import_react.useCallback)((w, h) => {
	...
	const provinceFit = (0, import_react.useCallback)((index, w, h) => {
		const prov = data.provinces[index];
		let minx = Infinity, miny = Infinity, maxx = -Infinity, maxy = -Infinity;
	...
	const buildDenseDots = (0, import_react.useCallback)((index) => {
		const cached = denseCache.current.get(index);
		if (cached) return cached;
		const prov = data.provinces[index];
		if (!prov) return [];
		const testRings = [];
		if (prov.cities && prov.cities.length > 0 && !NO_CITY_SPLIT$1.has(prov.id)) for (const city of prov.cities) testRings.push(...city.borders);
	...
	const animateTo = (target, fadeTo, ms = 640) => {
	...
	const draw = (0, import_react.useCallback)(() => {
		...
		const strokePolylines = (lines, color, width) => {
		...
		const rDot = .95;
		const paintDots = (fill, predicate) => {
			ctx.fillStyle = fill;
			ctx.beginPath();
			for (const d of data.china) {
		...
		const dense = fade > .12 && focusedIdx != null ? denseCache.current.get(focusedIdx) : void 0;
		const paintDense = (fill) => {
		...
		paintDots(withAlpha(paperHex, .58 * (1 - fade * .48)), (pidx) => {
		...
		if (focusedIdx != null && focusedIdx !== hoverIndex) {
			...
			else paintDots(withAlpha(paperHex, .62 + fade * .2), (pidx) => pidx === focusedIdx);
		}
		if (hoverIndex != null) {
			if (hoverIndex === focusedIdx && dense && dense.length) paintDense(withAlpha(cinnabarHex, .92));
			else paintDots(withAlpha(cinnabarHex, .92), (pidx) => pidx === hoverIndex);
		}
		...
		if (fade < .42 && insetSpecs.length) {
			const compact = w < 560;
			const boxW = compact ? Math.min(62, Math.max(52, w * .15)) : Math.min(86, Math.max(68, w * .082));
			const boxH = boxW * (compact ? .8 : .84);
			...
			const boxes = insetSpecs.map((spec, i) => ({
				...spec,
	...
	const hitCity = (x, y) => {
		...
		if (!prov || NO_CITY_SPLIT$1.has(prov.id)) return null;
	...
	const hoverName = cityBadge ? cityBadge : hoverIndex != null ? shortProvinceName(data.provinces[hoverIndex]?.name ?? "") : "";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), hoverName ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "pointer-events-none absolute left-4 top-4 rounded-md bg-ink/80 px-3 py-1.5 text-sm text-paper sm:left-5",
			children: hoverName
		}) : null]
	});
});
var provinceMeta = {
	"11": {
		short: "北京",
		region: "north",
		blurb: "中轴线、宫殿与城墙。把一座都城当成可以走完的礼仪。"
	},
	"12": {
		short: "天津",
		region: "north",
		blurb: "海河与租界的折中。从北京顺路南下的另一张北方面孔。"
	},
	"13": {
		short: "河北",
		region: "north",
		blurb: "长城最能走的段落在这里。山脊比城楼更值得被记住。"
	},
	"14": {
		short: "山西",
		region: "north",
		blurb: "寺庙与窑洞。平遥、五台把时间叠得很厚。"
	},
	"15": {
		short: "内蒙古",
		region: "north",
		blurb: "草原把地平线放得很低。夏季是唯一需要认真挑选的季节。"
	},
	"21": {
		short: "辽宁",
		region: "north",
		blurb: "滨海与工业遗迹并存。沈阳故宫是另一座较小的紫禁城。"
	},
	"22": {
		short: "吉林",
		region: "north",
		blurb: "长白山的天池只在云开时出现。雾比攻略更有主权。"
	},
	"23": {
		short: "黑龙江",
		region: "north",
		blurb: "冬天把城市变成冰。哈尔滨是为严寒准备的节日。"
	},
	"31": {
		short: "上海",
		region: "jiangnan",
		blurb: "外滩的天际线是中国进入二十世纪的切口。夜比昼更像上海。"
	},
	"32": {
		short: "江苏",
		region: "jiangnan",
		blurb: "园、水、运河。苏州把一座山放进一亩池塘。"
	},
	"33": {
		short: "浙江",
		region: "jiangnan",
		blurb: "西湖被写了千年。龙井与灵隐把湖从拥挤里救出来。"
	},
	"34": {
		short: "安徽",
		region: "jiangnan",
		blurb: "黄山过夜，徽州醒来。云海只对住在山上的人出现。"
	},
	"35": {
		short: "福建",
		region: "jiangnan",
		blurb: "土楼、海岸、一碗面线。厦门把海风写进巷子。"
	},
	"36": {
		short: "江西",
		region: "jiangnan",
		blurb: "庐山与景德镇。山和瓷，都需要把脚步放慢。"
	},
	"37": {
		short: "山东",
		region: "north",
		blurb: "泰山把高度写成一种朝圣。青岛把海交给红瓦与风。"
	},
	"41": {
		short: "河南",
		region: "north",
		blurb: "洛阳与开封把王朝留在中原。少林只是其中一个注脚。"
	},
	"42": {
		short: "湖北",
		region: "jiangnan",
		blurb: "长江在这里变宽。神农架把雾留给愿意走林道的人。"
	},
	"43": {
		short: "湖南",
		region: "southwest",
		blurb: "张家界的石峰从云里长出来。湘西比门票更值得迷路。"
	},
	"44": {
		short: "广东",
		region: "southwest",
		blurb: "早茶是一种制度。海岸与城，都走得很快。"
	},
	"45": {
		short: "广西",
		region: "southwest",
		blurb: "漓江把山写成倒影。竹筏比游轮更接近江的脾气。"
	},
	"46": {
		short: "海南",
		region: "southwest",
		blurb: "冬季的海。三亚之外还有更安静的海湾。"
	},
	"50": {
		short: "重庆",
		region: "southwest",
		blurb: "山城把江写成楼梯。雾与火锅是同一件事的两面。"
	},
	"51": {
		short: "四川",
		region: "southwest",
		blurb: "盆地里的闲，与九寨的蓝。辣只是入口。"
	},
	"52": {
		short: "贵州",
		region: "southwest",
		blurb: "黄果树与苗寨。喀斯特在这里比广西更密。"
	},
	"53": {
		short: "云南",
		region: "southwest",
		blurb: "一座省的海拔可以换三次季节。丽江只是入口。"
	},
	"54": {
		short: "西藏",
		region: "plateau",
		blurb: "先学会走得慢。布达拉宫需要预约，也需要氧气一样的耐心。"
	},
	"61": {
		short: "陕西",
		region: "northwest",
		blurb: "地下还有一支军队。面上的蒜水把长安留在舌尖。"
	},
	"62": {
		short: "甘肃",
		region: "northwest",
		blurb: "敦煌的风把时间吹薄。河西走廊是还活着的路。"
	},
	"63": {
		short: "青海",
		region: "northwest",
		blurb: "青海湖把天空放得很低。入藏之前的高原预习。"
	},
	"64": {
		short: "宁夏",
		region: "northwest",
		blurb: "贺兰山与黄河。西夏陵把一座消失的国留在风里。"
	},
	"65": {
		short: "新疆",
		region: "northwest",
		blurb: "南疆的喀什，北疆的伊犁。距离本身就是风景。"
	},
	"71": {
		short: "台湾",
		region: "jiangnan",
		blurb: "岛屿把山和海压得很近。季节与大陆错开半拍。"
	},
	"81": {
		short: "香港",
		region: "southwest",
		blurb: "维多利亚港的密度。山与城叠在同一条天际线上。"
	},
	"82": {
		short: "澳门",
		region: "southwest",
		blurb: "半岛把葡式与粤语叠在一起。比灯火更值得走的是小巷。"
	}
};
function destsForProvince(provinceId) {
	return destinations.filter((d) => destGeo[d.slug]?.provinceId === provinceId);
}
function destsForRegion(region) {
...
var NO_CITY_SPLIT = /* @__PURE__ */ new Set([
	"11",
	"12",
	"31",
	"50",
...
function DestRow({ dest, index, active, saved, onSelect }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		type: "button",
		onClick: onSelect,
		className: cn("flex min-h-12 w-full items-center gap-3 rounded-md p-1.5 text-left transition-[background-color,color] duration-150", active ? "bg-paper/10 text-paper" : "text-paper/85 hover:bg-paper/10"),
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						className: "text-latin text-[11px] tabular-nums tracking-widest text-stone-light",
						children: String(index + 1).padStart(2, "0")
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "mt-0.5 block truncate text-xs text-stone-light",
					children: [
						dest.province,
						" · ",
						dest.days
			...
			saved ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bookmark, {
...
function DashboardPanel({ data, hoverIndex, selectedIndex, selectedSlug, onSelectProvince, onSelectDest, className }) {
	...
	const savedSlugs = usePlannerHydration() ? saved : [];
	const plan = composeItinerary(savedSlugs, days);
	const dest = selectedSlug ? getDestination(selectedSlug) : void 0;
	const province = selectedIndex != null ? data?.provinces[selectedIndex] : void 0;
	const hoverProv = hoverIndex != null ? data?.provinces[hoverIndex] : void 0;
	const meta = province ? provinceMeta[province.id] : void 0;
	const provinceDests = province ? destsForProvince(province.id) : [];
	const regionDests = meta ? destsForRegion(meta.region) : [];
	const region = meta ? regions.find((r) => r.id === meta.region) : void 0;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
		className: cn("flex min-h-0 flex-col overflow-hidden bg-ink-soft text-paper", className),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "dash-scroll min-h-0 flex-1 overflow-y-auto p-5",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start justify-between gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-latin text-[11px] tracking-[0.32em] uppercase text-stone-light",
						children: "Atlas"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mt-1 font-display text-2xl tracking-wide",
						children: "图幅"
					})] }), selectedIndex != null || selectedSlug ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						"aria-label": "返回总览",
						onClick: () => {
							onSelectDest(null);
				...
				dest ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-latin mt-4 text-xs tracking-[0.24em] uppercase text-stone-light",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-1 text-sm text-stone-light",
							children: [
								dest.province,
								" · ",
								dest.days,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm leading-relaxed text-paper/80",
							children: dest.excerpt
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dl", {
							className: "mt-4 space-y-2 border-t border-paper/10 pt-4",
							children: dest.practical.slice(0, 3).map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "grid grid-cols-3 gap-2 text-sm",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
									className: "text-stone-light",
									children: row.label
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", {
									className: "col-span-2 text-paper/90",
									children: row.value
								})]
							}, row.label))
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SaveButton, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									children: ["阅读全文", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
										className: "size-4",
										strokeWidth: 1.6
									})]
								})
				...
				}, dest.slug) : province ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rise-in mt-5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-latin text-xs tracking-[0.24em] uppercase text-stone-light",
							children: region?.nameEn ?? "Province"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-1 font-display text-3xl",
							children: shortProvinceName(province.name)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-sm leading-relaxed text-paper/80",
							children: meta?.blurb
						}),
						province.cities && province.cities.length > 0 && !NO_CITY_SPLIT.has(province.id) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-6 text-xs tracking-[0.2em] uppercase text-stone-light",
							children: "地级市 · 州"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-3 flex flex-wrap gap-1.5",
							children: province.cities.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-6 text-xs tracking-[0.2em] uppercase text-stone-light",
							children: provinceDests.length > 0 ? "本省目的地" : "同带可走"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-2 space-y-1",
							children: (provinceDests.length > 0 ? provinceDests : regionDests).map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DestRow, {
								dest: d,
						...
						provinceDests.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-xs leading-relaxed text-stone-light",
							children: "本省尚未单独收录。可从同带目的地开始，或继续点选地图上的朱砂圆点。"
						}) : null
					]
				}, province.id) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rise-in mt-5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm leading-relaxed text-paper/80",
							children: "点选省份，或地图上的朱砂圆点。周边国家只作方位，不可交互。"
						}),
						hoverProv ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-2 text-sm text-stone-light",
							children: ["现悬停：", shortProvinceName(hoverProv.name)]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm text-stone-light",
							children: "滚轮缩放。点邻省直接切换；点海洋、境外或再缩小，回到全国。"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-5 grid grid-cols-3 gap-3 border-y border-paper/10 py-4",
							children: [
								{
									n: "34",
									l: "省区"
								...
								className: "text-latin text-2xl tabular-nums text-cinnabar",
								children: s.n
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1 text-xs text-stone-light",
								children: s.l
							})] }, s.l))
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-5 text-xs tracking-[0.2em] uppercase text-stone-light",
							children: "地理带"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-2 space-y-1",
							children: destinations.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DestRow, {
								dest: d,
								index: i,
								active: false,
								saved: savedSlugs.includes(d.slug),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "mt-8 border-t border-paper/10 pt-5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								...
								children: "行程"
							}), savedSlugs.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: clear,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: DAY_OPTIONS.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								onClick: () => setDays(n),
								className: cn("inline-flex h-10 min-w-11 items-center justify-center rounded-full px-3.5 text-sm tabular-nums", days === n ? "bg-cinnabar text-paper" : "border border-paper/15 text-paper/80 hover:border-paper/40"),
								children: [n, " 日"]
							}, n))
						}),
						savedSlugs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-sm leading-relaxed text-stone-light",
							children: "点选朱砂圆点或下方目的地，加入行程。地图会用虚线把它们连起来。"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
								className: "mt-4 space-y-2",
								children: savedSlugs.map((slug) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											children: [d.nameZh, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "ml-2 text-xs text-stone-light",
												children: d.province
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											type: "button",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
								className: "mt-4 space-y-2 border-t border-paper/10 pt-4",
								children: plan.slice(0, 6).map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									className: "grid grid-cols-[2.5rem_1fr] gap-2 text-sm",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "text-latin tabular-nums text-cinnabar",
										children: ["D", p.day]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "leading-snug text-paper/90",
										children: p.title
									})]
								}, `${p.day}-${p.slug}-${p.title}`))
							}),
							plan.length > 6 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-2 text-xs text-stone-light",
								children: [
									"另有 ",
									plan.length - 6,
									" 日写在完整行程里。"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: "/planner",
									children: ["完整行程", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
										className: "size-4",
										strokeWidth: 1.6
									})]
								})
...
function Home() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (!g) return;
		const pidx = data.provinces.findIndex((p) => p.id === g.provinceId);
		if (pidx >= 0) setSelectedIndex((curr) => curr === pidx ? curr : pidx);
	}, [data.provinces, selectedSlug]);
	const onSelectDest = (slug) => {
	...
	const onHoverProvince = (index) => {
		setHoverIndex((prev) => prev === index ? prev : index);
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "scheme-ink flex h-svh flex-col bg-ink pt-16 text-paper sm:pt-[4.5rem]",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex min-h-0 flex-1 flex-col lg:flex-row",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative min-h-0 min-w-0 flex-1",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChinaMap, {
						ref: mapRef,
						data,
						hoverIndex,
						selectedIndex,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-ink/40 to-transparent" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "pointer-events-none absolute bottom-5 left-5 hidden text-[11px] tracking-[0.2em] uppercase text-paper/45 sm:block",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "浅线 · 邻邦" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1",
								children: "点阵 · 中国"
							}),
